...
<div align="center" style="text-align:center;margin-top:30px;margin-bottom:20px">
    <img alt="Java version" src=https://img.shields.io/static/v1?label=java&message=%20%3E=8&logo=openjdk" />
    <img alt="MySql version" src="https://img.shields.io/static/v1?label=mysql&message=%20=8.0&logo=mysql&color=blue" />
    <img alt="Redis version" src=https://img.shields.io/static/v1?label=redis&message=%20%3E=4&logo=redis&color=red" />
