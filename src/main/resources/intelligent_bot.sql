...
CREATE TABLE `sys_config` (
  ...
  `gpt4_vision_url` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'gp4内容识别地址',
  ...
  `is_open_gpt_vision` tinyint DEFAULT '0' COMMENT 'gpt内容识别开关 0-未开启、1开启',
