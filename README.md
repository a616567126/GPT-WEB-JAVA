...
## 💻  INSTALL AND START  
       安装步骤
        ...
        12.打包java代码复制到/usr/local/siana/下，后续都已这个为准，可根据自己的项目实际位置自行更改
        ...
        19.使用Hbuilder打开移动端代码，打包方式（网站-PC Web或手机H5(仅适用于 uni-app)）
        20.可使用nginx，代理图片服务器，客户端及管理端页面
        21.系统中使用百度翻译与百度内容审核，查看下方教程进行开通
        22.GPT与Midjourney需要外网环境，可使用香港服务器，延迟低，可购买下方浅夏云，
